...
def find_dates(text):
    ...
    listAll = re.findall(\
        r"[0-3]?[0-9]\. ?[A-Za-zä]+ [0-9]{4}, [1-2]?[0-9]:[0-9]{2} Uhr", text)
    for date in listAll:
        dictionary = {}
